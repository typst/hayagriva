...
use crate::rendering::names::{DisambiguatedNameForm, NameDisambiguationProperties};
use crate::taxonomy::NumberOrPageVariableResult;
...
/// A reference to an [`EntryLike`] within a [`CitationRequest`].
#[derive(Debug, Clone, PartialEq)]
...
#[derive(Clone)]
pub struct TransparentLocator(pub Arc<dyn TransparentLocatorPayload>);
