...
//! well as the source code of 'hayagriva-archive/src/lib.rs', used to retrieve those
...
const ARCHIVE_STYLES_PATH: &str = "../crates/hayagriva-archive/archive/styles/";
const ARCHIVE_LOCALES_PATH: &str = "../crates/hayagriva-archive/archive/locales/";
const ARCHIVE_SRC_PATH: &str = "../crates/hayagriva-archive/src/lib.rs";
...
///
/// ```sh
/// cargo test --test test -- archiver --ignored
/// ```
#[test]
#[ignore]
fn always_archive() {
...
fn write_styles_section(
    ...
    writeln!(w, "//! Archive CSL styles. Included in Typst.")?;
    writeln!(w, "// This file is generated by tests/src/archiver.rs")?;
