...
fn write_styles_section(
    ...
    writeln!(w, "// This file is generated by tests/archiver.rs")?;
...
const STYLE_IDS: [&str; 85] = [
    ...
    "http://www.zotero.org/styles/china-national-standard-gb-t-7714-2025-author-date",
    "http://www.zotero.org/styles/china-national-standard-gb-t-7714-2025-note",
    "http://www.zotero.org/styles/china-national-standard-gb-t-7714-2025-numeric",
...
const OVERRIDES: [Override; 26] = [
    ...
    Override::first(
        "china-national-standard-gb-t-7714-2025-author-date",
        "gb-7714-2025-author-date",
    ),
    Override::first("china-national-standard-gb-t-7714-2025-note", "gb-7714-2025-note"),
    Override::first(
        "china-national-standard-gb-t-7714-2025-numeric",
